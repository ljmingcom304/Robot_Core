...
public class SettingsPopWindow extends PopupWindow {
    ...
    public SettingsPopWindow(final PlayerMainActivity context, View ctView) {
...
//        this.setFocusable(true);
    ...
    public static SettingsPopWindow createSettingsPopWindow(final PlayerMainActivity context) {
