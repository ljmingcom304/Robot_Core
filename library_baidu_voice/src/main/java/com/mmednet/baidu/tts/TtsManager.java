...
public class TtsManager {
    ...
    public static TtsManager init(Context context) {
        return init(context, AppUtils.getAppId(context), AppUtils.getApiKey(context), AppUtils.getSecretKey(context));
    }

    public static TtsManager init(Context context, String appId, String apiKey, String secretKey) {
        ...
        ttsManager.mSpeechSynthesizer.setAppId(appId);
        ttsManager.mSpeechSynthesizer.setApiKey(apiKey, secretKey);
