...
public class TimePicker extends View {
    ...
    private void init() {
        ...
        mPaint.setColor(ContextCompat.getColor(context, R.color.view_text1));
        //第二个paint
        nPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        nPaint.setStyle(Style.FILL);
        nPaint.setTextAlign(Align.CENTER);
        nPaint.setColor(ContextCompat.getColor(context, R.color.view_text2));
    }
     ...
     * @param otherColor
     */
    public void setColor(int mainColor, int otherColor) {
        if (mainColor > 0) {
