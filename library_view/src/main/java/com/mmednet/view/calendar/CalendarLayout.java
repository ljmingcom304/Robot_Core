...
public final class CalendarLayout extends LinearLayout {
    ...
    void updateContentViewTranslateY() {
        ...
        if (mDelegate.getMonthViewShowMode() == CalendarViewDelegate.MODE_ALL_MONTH) {
            ...
            mContentViewTranslateY = DateUtil.getMonthViewHeight(calendar.getYear(), calendar.getMonth(), mItemHeight)
                    - mItemHeight;
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mContentView != null && mMonthView != null) {
            int h = getHeight() - mItemHeight
                    ...
                    DateUtil.dipToPx(getContext(), 40))
                    - DateUtil.dipToPx(getContext(), 1);
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                */
                if (dy > 0 && mContentView.getTranslationY() == -mContentViewTranslateY
                        && y >= DateUtil.dipToPx(getContext(), 98)) {
                    if (!isScrollTop())
                        return false;
                }

                if (dy > 0 && mContentView.getTranslationY() == 0 && y >= DateUtil.dipToPx(getContext(), 98)) {
                    return false;
                }
