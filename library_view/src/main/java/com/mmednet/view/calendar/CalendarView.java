...
public class CalendarView extends FrameLayout {
    ...
    private void init(Context context) {
        LayoutInflater.from(context).inflate(R.layout.view_calendar_layout, this, true);
        ...
        params.setMargins(0, mDelegate.getWeekBarHeight() + DateUtil.dipToPx(context, 1), 0, 0);
    ...
    public void setRange(int minYear, int minYearMonth,
        ...
        if (DateUtil.isCalendarInRange(mDelegate.mSelectedCalendar, mDelegate)) {
    ...
    public void scrollToCurrent(boolean smoothScroll) {
        if (!DateUtil.isCalendarInRange(mDelegate.getCurrentDay(), mDelegate)) {
            return;
        }
        mDelegate.mSelectedCalendar = mDelegate.createCurrentDate();
        mWeekBar.onDateSelected(mDelegate.mSelectedCalendar,false);
