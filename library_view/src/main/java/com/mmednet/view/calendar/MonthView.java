...
public abstract class MonthView extends BaseView {
            ...
            if (calendar != null) {
                ...
                if (mParentLayout != null) {
                    if (calendar.isCurrentMonth()) {
                        ...
                        mParentLayout.setSelectWeek(DateUtil.getWeekFromDayInMonth(calendar));
                    }
    ...
    void setCurrentDate(int year, int month) {
        ...
        if (mDelegate.getMonthViewShowMode() == CalendarViewDelegate.MODE_ALL_MONTH) {
            ...
            mHeight = DateUtil.getMonthViewHeight(year, month, mItemHeight);
        }
    ...
    private void initCalendar() {
        ...
        int mDayCount = DateUtil.getMonthDaysCount(mYear, mMonth);
        ...
        if (mMonth == 1) {//如果是1月
            ...
            nextYear = mYear;
            nextMonth = mMonth + 1;
            preMonthDaysCount = mPreDiff == 0 ? 0 : DateUtil.getMonthDaysCount(preYear, preMonth);
