...
final class LunarCalendar {
    ...
    static void init(Context context) {
        ...
        MONTH_STR = context.getResources().getStringArray(R.array.view_lunar_first_of_month);
        TRADITION_FESTIVAL_STR = context.getResources().getStringArray(R.array.view_tradition_festival);
        DAY_STR = context.getResources().getStringArray(R.array.view_lunar_str);
        SOLAR_CALENDAR = context.getResources().getStringArray(R.array.view_solar_festival);
    }
    ...
    static void setupLunarCalendar(Calendar calendar) {
        ...
        calendar.setWeekend(DateUtil.isWeekend(calendar));
        calendar.setWeek(DateUtil.getWeekFormCalendar(calendar));
        ...
        calendar.setLeapYear(DateUtil.isLeapYear(year));
        if (lunar[3] == 1) {//如果是闰月
