...
final class CalendarViewDelegate {
    ...
    CalendarViewDelegate(Context context, @Nullable AttributeSet attrs) {
        ...
        mWeekBarHeight = (int) array.getDimension(R.styleable.CalendarView_week_bar_height, DateUtil.dipToPx(context, 40));
        ...
        mDayTextSize = array.getDimensionPixelSize(R.styleable.CalendarView_day_text_size, DateUtil.dipToPx(context, 16));
        mLunarTextSize = array.getDimensionPixelSize(R.styleable.CalendarView_lunar_text_size, DateUtil.dipToPx(context, 10));
        mCalendarItemHeight = (int) array.getDimension(R.styleable.CalendarView_calendar_height, DateUtil.dipToPx(context, 56));

        //年视图相关
        mYearViewMonthTextSize = array.getDimensionPixelSize(R.styleable.CalendarView_year_view_month_text_size, DateUtil.dipToPx(context, 18));
        mYearViewDayTextSize = array.getDimensionPixelSize(R.styleable.CalendarView_year_view_day_text_size, DateUtil.dipToPx(context, 8));
    ...
    private void init() {
        ...
        Date d = new Date();
        mCurrentDate.setYear(DateUtil.getDate("yyyy", d));
        mCurrentDate.setMonth(DateUtil.getDate("MM", d));
        mCurrentDate.setDay(DateUtil.getDate("dd", d));
    ...
    void setRange(int minYear, int minYearMonth,
        ...
        mCurrentWeekViewItem = DateUtil.getWeekFromCalendarBetweenYearAndYear(mCurrentDate, mMinYear, mMinYearMonth);
    }
