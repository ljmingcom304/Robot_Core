...
public final class WeekViewPager extends ViewPager {
    ...
    private void init() {
        mWeekCount = DateUtil.getWeekCountBetweenYearAndYear(mDelegate.getMinYear(), mDelegate.getMinYearMonth(),
    ...
    void scrollToCurrent(boolean smoothScroll) {
        isUsingScrollToCalendar = true;
        int position = DateUtil.getWeekFromCalendarBetweenYearAndYear(mDelegate.getCurrentDay(),
    ...
    void updateSelected(Calendar calendar, boolean smoothScroll) {
        int position = DateUtil.getWeekFromCalendarBetweenYearAndYear(calendar, mDelegate.getMinYear(), mDelegate.getMinYearMonth()) - 1;
        int curItem = getCurrentItem();
        if (curItem == position) {
            isUsingScrollToCalendar = false;
        }
    ...
    private class WeekViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            Calendar calendar = DateUtil.getFirstCalendarFromWeekCount(mDelegate.getMinYear(), mDelegate.getMinYearMonth(), position + 1);
            WeekView view;
