...
final class YearAdapter extends BaseAdapter<Month> {
    ...
    YearAdapter(Context context) {
        super(context);
        mTextHeight = DateUtil.dipToPx(context,56);
    }
    ...
    RecyclerView.ViewHolder onCreateDefaultViewHolder(ViewGroup parent, int type) {
        return new YearViewHolder(mInflater.inflate(R.layout.view_calendar_item_list_year, parent, false), mDelegate);
    }
