...
import com.mmednet.face.model.IrequestParams;
import com.mmednet.face.parser.AccessTokenParser;
import com.mmednet.face.parser.Iparser;
import com.mmednet.face.utils.Base64RequestBody;
...
public class HttpUtil {
    ...
    public <T> void post(String path, IrequestParams params, final Iparser<T> parser, final OnResultListener<T>
            listener) {
        post(path, "images", params, parser, listener);
    }

    public <T> void post(String path, String key, IrequestParams params,
                         final Iparser<T> parser, final OnResultListener<T> listener) {
