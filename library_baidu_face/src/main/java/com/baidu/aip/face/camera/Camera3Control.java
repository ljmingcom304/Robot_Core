...
public class Camera3Control implements ICameraControl {
    ...
    private OnFrameListener<byte[]> onFrameListener;
    ...
    public Camera3Control(Context activity) {
    ...
    private final CameraDevice.StateCallback deviceStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onOpened(@NonNull CameraDevice cameraDevice) {
            cameraLock.release();
            Camera3Control.this.cameraDevice = cameraDevice;
        ...
        public void onDisconnected(@NonNull CameraDevice cameraDevice) {
            cameraLock.release();
            cameraDevice.close();
            Camera3Control.this.cameraDevice = null;
        }
            ...
            imageReader.setOnImageAvailableListener(new OnImageAvailableListener() {
                ...
                public void onImageAvailable(ImageReader reader) {
                    ...
                    if (onFrameListener != null) {
                        ...
                        cropRect.readFromParcel(in);
                        byte[] byteArray = in.createByteArray();
                        onFrameListener.onPreviewFrame(byteArray, rotation, image.getWidth(), image.getHeight());
