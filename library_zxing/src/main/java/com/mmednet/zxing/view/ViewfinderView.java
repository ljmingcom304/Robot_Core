...
package com.mmednet.zxing.view;
...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = theme.obtainStyledAttributes(attrs, R.styleable.ViewfinderView, 0, 0);
        if (array != null) {
            maskColor = array.getColor(R.styleable.ViewfinderView_reactColor, Color.parseColor("#50000000"));
            reactColor = array.getColor(R.styleable.ViewfinderView_reactColor, Color.WHITE);
            scanLineColor = array.getColor(R.styleable.ViewfinderView_scanLineColor, Color.WHITE);
            frameLineColor = array.getColor(R.styleable.ViewfinderView_frameLineColor, Color.WHITE);
            resultColor = array.getColor(R.styleable.ViewfinderView_frameLineColor, Color.BLACK);
            resultPointColor = array.getColor(R.styleable.ViewfinderView_frameLineColor, Color.TRANSPARENT);
            array.recycle();
        }
