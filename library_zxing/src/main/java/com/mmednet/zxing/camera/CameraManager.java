...
package com.mmednet.zxing.camera;
...
public final class CameraManager {
    ...
    private boolean isFullScreenScan;//是否全屏扫描
    ...
    public CameraManager(Context context, boolean isFullScreenScan) {
     ...
     */
    public synchronized boolean isSupportFlashLight() {
     ...
     * 切换闪光灯
     *
     * @return true闪光灯被打开false闪光灯被关闭
     */
    public synchronized boolean switchFlashLight() {
        ...
        if (isSupportFlashLight()) {
            ...
            Toast.makeText(context, "设备不支持闪光灯", Toast.LENGTH_LONG).show();
        }
        return result;
    }
    ...
    public synchronized Rect getFramingRect() {
        if (framingRect == null) {
            ...
            if (screenResolution.x < screenResolution.y) {
                width = (int) (screenResolutionX * 0.6);
                height = width;
                /*水平居中  偏上显示*/
                ...
                height = (int) (screenResolutionY * 0.6);
                width = height;
                /*水平居中  偏上显示*/
                int leftOffset = (screenResolution.x - width) / 2;
                int topOffset = (screenResolution.y - height) / 5;
