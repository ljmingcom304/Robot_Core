...
public class TextDrawable extends Drawable {
    ...
    /* LayoutDialog is used to measure and draw the text */
    ...
    public TextDrawable(Context context) {
        ...
        if (ap != null) {
            for (int i = 0; i < ap.getIndexCount(); i++) {
                ...
                switch (attr) {
                    case 0: //TextBean Size
                        textSize = a.getDimensionPixelSize(attr, textSize);
                        break;
                    case 1: //Typeface  
                        typefaceIndex = a.getInt(attr, typefaceIndex);
                        break;
                    case 2: //TextBean Style
                        styleIndex = a.getInt(attr, styleIndex);
                        break;
                    case 3: //TextBean Color
     ...
     *
     * @param text TextBean to display
     */
     ...
     *
     * @param size TextBean size value, in sp
     */
     ...
     * @param size TextBean size value
     */
     ...
     *
     * @param size TextBean scale factor
     */
     ...
     *
     * @param align TextBean alignment value.  Should be set to one of:
     *              <p>
    ...
    public void setEnabled(boolean enabled) {
        ...
        if (mTextColors != null) {
            setState(enabled ? new int[]{android.R.attr.state_enabled} : new int[]{});
        }
    }
